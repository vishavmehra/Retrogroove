...
interface SeventysDelightsProps {
  songs: Song[];
}
...
const SeventysDelights: React.FC<SeventysDelightsProps> = ({ songs }) => {
  ...
  useEffect(() => {
    ...
    const filteredSongs = songs.filter(
      (song) => song.year >= 1970 && song.year <= 1979
    );
...
export default SeventysDelights;
